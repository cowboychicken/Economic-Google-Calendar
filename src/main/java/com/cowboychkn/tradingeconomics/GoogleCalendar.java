...
public class GoogleCalendar implements AutoCloseable{

    private static final String APPLICATION_NAME = "TradingEconomics.com Calendar";
    ...
    */
    ...
    public GoogleCalendar(String calendarIdInput) throws IOException, GeneralSecurityException {
        ...
        // dummy call to force test of credentials. So that Try-w/resource in RunUpdate works. 
